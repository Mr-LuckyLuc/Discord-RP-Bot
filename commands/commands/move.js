...
module.exports = {
	...
	async execute(interaction) {
		...
		await interaction.reply(`You are being moved to ${destination.name}`);	//check if destination is in list with destinations
		...
		await interaction.followUp(`You have moved to ${destination.name}`);
	},
};